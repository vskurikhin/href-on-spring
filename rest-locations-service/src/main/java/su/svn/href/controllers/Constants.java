...
public final class Constants
{
    ...
    public static final String REST_V1_LOCATIONS = "/v1/locations";
    ...
    public static final String MODEL_AUTHOR = "author";
    public static final String MODEL_AUTHORS = "authors";
